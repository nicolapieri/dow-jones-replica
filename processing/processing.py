...
functions.test_opt(compat_2003_01_27, '2003-01-27', '2003-06-01', '2004-04-08')
functions.test_opt(compat_2004_04_08, '2004-04-08', '2004-04-09', '2005-11-21')
functions.test_opt(compat_2005_11_21, '2005-11-21', '2005-11-22', '2008-02-19')
functions.test_opt(compat_2008_02_19, '2008-02-19', '2008-02-20', '2008-09-22')
functions.test_opt(compat_2008_09_22, '2008-09-22', '2008-09-23', '2009-06-08')
functions.test_opt(compat_2009_06_08, '2009-06-08', '2009-06-09', '2012-09-24')
functions.test_opt(compat_2012_09_24, '2012-09-24', '2012-09-25', '2013-09-23')
functions.test_opt(compat_2013_09_23, '2013-09-23', '2013-09-24', '2015-03-19')
functions.test_opt(compat_2015_03_19, '2015-03-19', '2015-03-20', '2018-06-26')
functions.test_opt(compat_2018_06_26, '2018-06-26', '2018-06-27', '2019-04-02')
functions.test_opt(compat_2019_04_02, '2019-04-02', '2019-04-03', '2020-04-06')
functions.test_opt(compat_2020_04_06, '2020-04-06', '2020-04-07', '2020-08-31')
functions.test_opt(compat_2020_08_31, '2020-08-31', '2020-09-01', '2023-05-31')

# aggregating results
Fin = pd.concat(
    [functions.Opt_2003_01_27, functions.Opt_2004_04_08, functions.Opt_2005_11_21, functions.Opt_2008_02_19, functions.Opt_2008_09_22, functions.Opt_2009_06_08, functions.Opt_2012_09_24,
     functions.Opt_2013_09_23, functions.Opt_2015_03_19, functions.Opt_2018_06_26, functions.Opt_2019_04_02, functions.Opt_2020_04_06, functions.Opt_2020_08_31])
